...
Reinforced concrete beam under 3PB loading with 4Ø12 bottom reinforcement.
...
def create_case_04a() -> CaseConfig:
    """
    3PB beam T5A1 (BOSCO) - 4Ø12 bottom reinforcement.

    Beam: 4000x400x200 mm
    Rebar: 4Ø12 mm bottom (y=35mm), 2Ø10 mm top (y=355mm)
    ...
    outputs = OutputConfig(
        output_dir="examples/gutierrez_thesis/outputs/case_04a",
        case_name="beam_3pb_t5a1_bosco",
    ...
    case = CaseConfig(
        ...
        description="3PB beam T5A1 (BOSCO) - 4Ø12 bottom + 2Ø10 top",
        geometry=geometry,
        concrete=concrete,
        loading=loading,
        outputs=outputs,
